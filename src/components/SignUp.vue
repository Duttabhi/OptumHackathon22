              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  <select class="select form-control-lg">
                    <option value="0" selected>Select Chronic Disease</option>
                ...
                <div class="col-md-6 mb-4 pb-2">
                  <select class="select form-control-lg">
                    <option value="0" selected>Select Test Name</option>
                    <option value="Asthama">Asthama</option>
                    <option value="Arthritis">Arthritis</option>
                    <option value="Diabetes">Diabetes</option>
                    <option value="Colitis">Colitis</option>
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="text" id="testvalue" class="form-control form-control-lg" />
